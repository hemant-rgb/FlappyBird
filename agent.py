...
class Agent :
    ...
    def run(self,is_training=False,render=False):
        ...
        if is_training :
            ...
            # copy the weight and bias of policy network to target network
        ...
        for episode in itertools.count():
            ...
            # env.close()
            if is_training:
                print(f"episode : {episode+1} and episode reward : {episode_reward} and epsilon value : {epsilon}")
                ...
                if episode_reward > best_reward:
                    log_msg = f"best reward is {episode_reward} for episode : {episode+1}"
                ...
                print(f"episode : {episode+1} and episode reward : {episode_reward}")
